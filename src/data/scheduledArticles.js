...
export const scheduledArticles = [
  ...radarArticles,
  {
    ...
    excerpt: 'Transição consistente combina direção, experimentos e evidências. A IA pode acelerar o processo, mas não substitui a escolha nem a exposição ao mundo real.',
    ...
    imageAlt: 'Fernando Parreiras falando ao público durante um evento profissional.',
    nature: 'Plano de desenvolvimento profissional baseado em experimentação e evidências.',
    cta: {
    ...
    content: [
      {
        heading: 'Noventa dias são um ciclo de aprendizagem, não uma promessa de reinvenção',
        paragraphs: [
      ...
      {
        heading: 'Dias 1 a 30: escolher um problema e mapear o ponto de partida',
        paragraphs: [
      ...
      {
        heading: 'Dias 61 a 90: testar posicionamento e escolher o próximo compromisso',
        paragraphs: [
        ...
        quote: 'Uma transição ganha força quando deixa de ser intenção e começa a produzir evidências.',
      },
      {
  ...
  },
  {
    ...
    title: 'Equipes com agentes de IA ainda precisam de responsabilidade humana',
    excerpt: 'Automatizar etapas não transfere responsabilidade. Organizações precisam definir quem autoriza, acompanha, interrompe e responde pelo trabalho realizado por agentes.',
    ...
    imageAlt: 'Fernando Parreiras conduzindo uma apresentação sobre tecnologia e negócios.',
    nature: 'Análise profissional sobre delegação, controle e responsabilidade organizacional.',
    cta: {
    ...
    content: [
      ...
      },
      {
        ...
        quote: 'Automação amplia a execução. Governança mantém a responsabilidade visível.',
      },
    ],
  },
  {
    ...
    excerpt: 'Cargos mudam mais rápido do que a capacidade de compreender problemas, mobilizar pessoas, decidir sob restrições e aprender com evidências.',
    track: 'mudanca-carreira',
    ...
    imageAlt: 'Fernando Parreiras conversando com uma audiência durante uma palestra.',
    ...
    content: [
      ...
      },
      {
        ...
        quote: 'Uma competência transferível só se torna visível quando é traduzida para um problema novo.',
      },
    ],
  },
  {
    ...
    excerpt: 'Cada caminho compra uma coisa diferente. A melhor escolha começa pelo tipo de evidência, repertório e relação que você precisa construir agora.',
    track: 'jovens-futuro',
    ...
    nature: 'Orientação educacional baseada em objetivos, evidências e experimentação.',
    cta: {
    ...
    content: [
      ...
      },
      {
        ...
        quote: 'A melhor formação é aquela que muda a qualidade do que você consegue compreender, fazer e demonstrar.',
      },
    ],
  },
  {
    slug: 'redesenhar-o-valor-que-voce-entrega-com-ia',
    title: 'Você não precisa competir com a IA. Precisa redesenhar o valor que entrega',
    excerpt: 'Competir por velocidade de produção é uma disputa estreita. O trabalho mais valioso começa na escolha do problema, nos critérios e na responsabilidade pelo resultado.',
    track: 'carreira-ia',
    ...
    nature: 'Análise profissional e exercício de reposicionamento para o trabalho com IA.',
    cta: {
    ...
    content: [
      ...
      },
      {
        ...
        quote: 'Seu valor não está em fazer mais rápido aquilo que deixou de precisar ser feito do mesmo jeito.',
      },
    ],
  },
  {
    ...
    excerpt: 'Produzir mais não corrige prioridades ruins. Antes de automatizar, líderes precisam esclarecer o resultado, os critérios e o que deveria deixar de ser feito.',
    track: 'lideranca-negocios',
    ...
    scheduledAt: '2026-09-06T09:00:00-03:00',
    image: '/images/em-cena/fernando-parreiras-palco-1600.webp',
    imageAlt: 'Fernando Parreiras apresentando uma reflexão de negócios no palco.',
    nature: 'Análise profissional baseada em desenho de operações e decisões executivas.',
    cta: {
    ...
    content: [
      {
        heading: 'A IA reduz o custo de produzir — inclusive o que não deveria existir',
        paragraphs: [
      ...
      },
      {
        ...
        quote: 'A pergunta não é quanto conseguimos produzir. É quanto do que produzimos realmente merecia existir.',
      },
    ],
  },
];
