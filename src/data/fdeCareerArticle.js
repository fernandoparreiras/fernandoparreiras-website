export const fdeCareerArticle = {
  slug: "fde-forward-deployed-engineer-carreira-ia",
  title:
  ...
  imageFit: "contain",
  nature:
    "Análise autoral de uma função emergente em IA; não descreve profissão regulamentada nem promete emprego, renda ou progressão.",
  cta: {
    label: "Conversar sobre carreira, produto e IA",
    href: "/contato/",
  },
  content: [
    {
      heading: "FDE não é um erro de digitação de SDE",
      paragraphs: [
    ...
    {
      heading: "A função começa onde a demonstração termina",
      paragraphs: [
    ...
    {
      heading: "O ciclo completo do trabalho",
      bullets: [
    ...
    {
      heading: "Não é consultoria com um novo nome",
      paragraphs: [
    ...
    {
      heading: "FDE e AI-Native Product Lead se encontram, mas não são sinônimos",
      paragraphs: [
    ...
    {
      heading: "Sete competências para construir agora",
      bullets: [
    ...
    {
      heading: "Um projeto de portfólio que demonstra a função",
      paragraphs: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "5. [Scale AI — Forward Deployed Engineer](https://scale.com/careers/4593571005). Descrição pública de colaboração com clientes, experimentação, full stack e influência no roadmap.",
        "6. [Cohere — Forward-deployed engineers should build capability, not dependency](https://cohere.com/blog/forward-deployed-engineers-capability-building). Perspectiva de fornecedor que explicita transferência de capacidade como critério de sucesso.",
        "7. [DORA — State of AI-assisted Software Development 2025](https://dora.dev/research/2025/dora-report/) e [user-centric focus](https://dora.dev/capabilities/user-centric-focus/). Pesquisa sobre o caráter sistêmico da adoção e a associação entre foco no usuário e desempenho; associação não prova causalidade universal.",
        "8. [World Economic Forum — Future of Jobs Report 2025, skills outlook](https://www.weforum.org/publications/the-future-of-jobs-report-2025/in-full/3-skills-outlook/). Pesquisa internacional de empregadores sobre habilidades em ascensão; não prevê uma trajetória individual.",
